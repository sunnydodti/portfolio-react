  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'left' }}>
        <h3>Basic Info:</h3>
        <p>
          <strong>Name:</strong> {data.profile?.name || 'N/A'}
        </p>
        <p>
          <strong>Title:</strong> {data.profile?.title || 'N/A'}
        </p>
        <p>
          <strong>Email:</strong> {data.profile?.email || 'N/A'}
        </p>
        <p>
          <strong>Location:</strong> {data.profile?.location || 'N/A'}
        </p>

        <h3>Stats:</h3>
        <p>
          <strong>Work Experience:</strong> {data.work_experience?.length || 0}{' '}
          jobs
        </p>
        <p>
          <strong>Projects:</strong>{' '}
          {Object.keys(data.projects || {}).length || 0} project types
        </p>
        <p>
