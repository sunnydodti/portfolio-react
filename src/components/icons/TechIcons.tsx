/* ==========================================================================
   Simple SVG Icons - Minimal Outline Icons
   ========================================================================== */
...
export const ReactIcon: React.FC<IconProps> = ({
  ...
  >
    ...
    <path d="M12 1c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8z" />
    <path d="M8 12h8" />
  </svg>
);

// TypeScript Icon (Code brackets)
...
// Python Icon (Brackets with dots)
...
// Generic Tech Icon (Circuit/Chip)
...
export const TechStackIcon: React.FC<IconProps> = ({
  size = 16,
  className = '',
}) => (
  <svg
